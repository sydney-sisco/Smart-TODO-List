...
var images=['/images/sam.jpeg','/images/syd.jpeg','/images/connie.jpeg'];  //Image path should be given here
var no = 15; // No of images should fall
var time = 0; // Configure whether image should disappear after x seconds (0=never):
var speed = 15; // Fix how fast the image should fall
...
for (i = 0; i < no; ++ i) {
	...
	document.write("<div id=\"dot"+ i +"\" style=\"POSITION: absolute; Z-INDEX: "+ i +"; VISIBILITY: visible; TOP: 15px;LEFT: 15px;\"><img src='"+images[(arrayIndex++)%3]+"' border=\"0\"><\/div>");
}
